...
int main() {
    ...
    while (true) {
        ...
        if (lm35TempC <= 32.0 && gasLevel > 0.8f) {
            lcd.cls();
            str[0] = '\0';
            lcd.locate(0, 0);
            ...
            lcd.locate(0, 0);
            str[0] = '\0';
        } else if (lm35TempC > 32.0 && gasLevel > 0.8f) {
            lcd.cls();
            str[0] = '\0';
            lcd.locate(0, 0);
            sprintf(str, "Alarm is on (Temp.)\n");
            lcd.printf("%s \n", str);
            ThisThread::sleep_for(1000ms);
            lcd.locate(0, 0);
            str[0] = '\0';
